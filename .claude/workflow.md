...
4. 🚧 Implement until tests pass — **Phase 2 (updater) DONE + gate-green + pushed**; the no-network doc reconciliation cold-eyed to convergence. **Phase 1 (signed `v0.1.0` release) blocked on user keygen.**
5. ⬜ Run `/audit`
6. ⬜ Run `/indie-review`
