...
1. ✅ Verify spec (`docs/specs/FIBR-0051.md` — cold-eyes CONVERGED loop 11, 2026-07-09)
2. ✅ Verify dependencies on the roadmap DAG (all deps ✅; reconciled FIBR-0039/0040/0049)
3. 🚧 Write failing tests (`tests/features/app_shell/`)
