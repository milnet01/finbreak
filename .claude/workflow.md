...
**FIBR-0014 (active):**
1. ✅ Brainstorm + write spec (`docs/specs/FIBR-0014.md`)
2. ✅ `/cold-eyes` the spec (converged 7 loops, project cap 7)
3. ⬜ Write failing tests (start with the D2 sqlcipher_export/rekey/cipher_compatibility spike)
4. ⬜ Implement until tests pass
5. ⬜ Run `/audit`
6. ⬜ Run `/indie-review`
7. ⬜ Fold / fix actionable findings
8. ⬜ Update CHANGELOG / ROADMAP / journal
9. ⬜ Commit, tag `FIBR-0014-complete`, push
