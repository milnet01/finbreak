...
> **UNPUSHED BATCH queued** — FIBR-0029 spec (cold-eyes loops 1–2) + impl + security-model cold-eyes + close-out. Push next. **NEXT after push: FIBR-0030** (forgotten-password destructive reset), **FIBR-0096** (per-release SHA256SUMS + SBOM), or **FIBR-0154** (3rd-tier categories).
