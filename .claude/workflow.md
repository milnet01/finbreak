...
> **NEXT STEP — FIBR-0156** (Report-an-Issue menu item, right of Donate → GitHub issues URL via `self._open_url`, mirroring Donate at `main_window.py:360-376`). Then FIBR-0155 (OBS publishing), then the Ants MCP feedback pass. **The FIBR-0154 API surface delivered (for reference):**
