...
| INV-9 | **Migration v10 → v11.** Additive nullable `ALTER TABLE ADD COLUMN`, version-gated, old rows NULL, version reads 11, idempotent, atomic rollback on a wedged ALTER. | `test_migration_v11.py` |
