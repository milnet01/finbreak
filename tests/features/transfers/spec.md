...
| INV-9 | **Schema v7 → v8.** `LATEST_SCHEMA_VERSION == 12`; a v7 vault upgrades to v8 with an empty `transfer_pairs` table, one atomic step (a wedged step leaves a re-openable v7). |
