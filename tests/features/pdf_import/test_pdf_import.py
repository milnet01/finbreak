...
# --------------------------------------------------------------------------- #
def test_INV8_v4_upgrades_through_v9_adds_nullable_column(paths):
    # A v4 vault now migrates through v5 (PDF password), v6 (statement provenance)
    # and v7 (category link), so run_migrations lands it at 9 — but the v4->v5
...
def test_INV8_first_run_vault_is_v9(service):
