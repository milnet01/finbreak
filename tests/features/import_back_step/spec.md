...
| INV-5 | **The banner strings are unchanged.** Rewording D7 would amend `docs/specs/FIBR-0146.md` and re-arm the rule-14 review gate; the point of adding the control is that the shipped sentence becomes true as written. INV-2 pins the mapped-source wording verbatim. |
